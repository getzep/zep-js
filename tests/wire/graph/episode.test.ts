...
describe("EpisodeClient", () => {
    ...
    test("get_by_graph_id (2)", async () => {
        ...
        await expect(async () => {
            return await client.graph.episode.getByGraphId("graph_id");
    ...
    test("get_by_user_id (2)", async () => {
        ...
        await expect(async () => {
            return await client.graph.episode.getByUserId("user_id");
        }).rejects.toThrow(Zep.BadRequestError);
    });
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.graph.episode.get("uuid");
        }).rejects.toThrow(Zep.BadRequestError);
    });
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.graph.episode.delete("uuid");
        }).rejects.toThrow(Zep.BadRequestError);
    });
    ...
    test("update (2)", async () => {
        ...
        await expect(async () => {
            return await client.graph.episode.update("uuid", {
                metadata: {
                    metadata: {
                        key: "value",
                    },
    ...
    test("get_nodes_and_edges (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new ZepClient({ maxRetries: 0, apiKey: "test", environment: server.baseUrl });
    ...
    test("get_nodes_and_edges (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new ZepClient({ maxRetries: 0, apiKey: "test", environment: server.baseUrl });
        ...
        await expect(async () => {
            return await client.graph.episode.getNodesAndEdges("uuid");
        }).rejects.toThrow(Zep.BadRequestError);
    });

    test("get_nodes_and_edges (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new ZepClient({ maxRetries: 0, apiKey: "test", environment: server.baseUrl });
