...
export class MessageClient {
    protected readonly _options: NormalizedClientOptions<MessageClient.Options>;
    ...
    private async __update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `messages/${core.url.encodePathParam(messageUUID)}`,
            ),
            method: "PATCH",
            headers: _headers,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "PATCH", "/messages/{messageUUID}");
    }
}
