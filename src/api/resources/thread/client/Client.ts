...
export class Thread {
    ...
    public getEpisodes(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getEpisodes(threadId, requestOptions));
    }
    ...
    private async __getEpisodes(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.ZepEnvironment.Default,
                `threads/${encodeURIComponent(threadId)}/episodes`,
            ),
            method: "GET",
            headers: mergeHeaders(
                this._options?.headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ZepTimeoutError("Timeout exceeded when calling GET /threads/{threadId}/episodes.");
            case "unknown":
                throw new errors.ZepError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
