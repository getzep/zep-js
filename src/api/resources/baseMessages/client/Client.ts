...
export declare namespace BaseMessages {
    interface Options {
...
export class BaseMessages {
    constructor(protected readonly _options: BaseMessages.Options = {}) {}
    ...
    public async getSessionMessages(
        ...
        if (_response.ok) {
            return await serializers.baseMessages.getSessionMessages.Response.parseOrThrow(_response.body, {
