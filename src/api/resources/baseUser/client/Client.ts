...
export declare namespace BaseUser {
    interface Options {
...
export class BaseUser {
    constructor(protected readonly _options: BaseUser.Options = {}) {}
    ...
    public async list(
        ...
        if (_response.ok) {
            return await serializers.baseUser.list.Response.parseOrThrow(_response.body, {
     ...
     */
    public async add(request: Zep.CreateUserRequest = {}, requestOptions?: BaseUser.RequestOptions): Promise<Zep.User> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ZepEnvironment.Default,
                "users"
    ...
    public async listOrdered(
        ...
        if (_response.ok) {
            return await serializers.baseUser.listOrdered.Response.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
     ...
     */
    public async get(userId: string, requestOptions?: BaseUser.RequestOptions): Promise<Zep.User> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ZepEnvironment.Default,
                `users/${userId}`
     ...
     */
    public async delete(userId: string, requestOptions?: BaseUser.RequestOptions): Promise<string> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ZepEnvironment.Default,
                `users/${userId}`
        ...
        if (_response.ok) {
            return await serializers.baseUser.delete.Response.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
     ...
     */
    public async getSessions(userId: string, requestOptions?: BaseUser.RequestOptions): Promise<Zep.Session[]> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ZepEnvironment.Default,
        ...
        if (_response.ok) {
            return await serializers.baseUser.getSessions.Response.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
