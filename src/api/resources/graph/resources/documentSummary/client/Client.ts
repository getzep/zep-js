...
export class DocumentSummary {
    protected readonly _options: DocumentSummary.Options;

    constructor(_options: DocumentSummary.Options = {}) {
     ...
     * @param {Zep.graph.GraphDocumentSummariesRequest} request
     * @param {DocumentSummary.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<Zep.DocumentSummary[]> {
    ...
    private async __getByGraphId(
        ...
        request: Zep.graph.GraphDocumentSummariesRequest = {},
        requestOptions?: DocumentSummary.RequestOptions,
    ): Promise<core.WithRawResponse<Zep.DocumentSummary[]>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.ZepEnvironment.Default,
                `graph/document-summary/graph/${encodeURIComponent(graphId)}`,
            ),
            method: "POST",
            ...
            requestType: "json",
            body: serializers.graph.GraphDocumentSummariesRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.graph.documentSummary.getByGraphId.Response.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ZepTimeoutError(
                    "Timeout exceeded when calling POST /graph/document-summary/graph/{graph_id}.",
                );
            case "unknown":
                throw new errors.ZepError({
