...
export class Messages {
     ...
     */
    public async list(sessionId: string, requestOptions?: Messages.RequestOptions): Promise<Zep.Message[]> {
        ...
        if (_response.ok) {
            return await serializers.messages.list.Response.parseOrThrow(_response.body, {
