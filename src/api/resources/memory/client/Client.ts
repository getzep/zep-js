...
export class Memory {
     ...
     */
    public async create(sessionId: string, request: Zep.Memory, requestOptions?: Memory.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ZepEnvironment.Default,
                `sessions/${sessionId}/memory`
     ...
     */
    public async delete(sessionId: string, requestOptions?: Memory.RequestOptions): Promise<string> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ZepEnvironment.Default,
                `sessions/${sessionId}/memory`
        ...
        if (_response.ok) {
            return await serializers.memory.delete.Response.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
