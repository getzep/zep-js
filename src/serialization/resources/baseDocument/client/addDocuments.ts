...
export const Request: core.serialization.Schema<
    serializers.baseDocument.addDocuments.Request.Raw,
...
export const Response: core.serialization.Schema<serializers.baseDocument.addDocuments.Response.Raw, string[]> =
