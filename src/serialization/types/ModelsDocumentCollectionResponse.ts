...
export const ModelsDocumentCollectionResponse: core.serialization.ObjectSchema<
    serializers.ModelsDocumentCollectionResponse.Raw,
...
export declare namespace ModelsDocumentCollectionResponse {
    interface Raw {
