...
export const ContextObservation: core.serialization.ObjectSchema<
    serializers.ContextObservation.Raw,
    Zep.ContextObservation
...
export declare namespace ContextObservation {
