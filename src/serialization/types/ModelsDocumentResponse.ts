...
export const ModelsDocumentResponse: core.serialization.ObjectSchema<
    serializers.ModelsDocumentResponse.Raw,
...
export declare namespace ModelsDocumentResponse {
    interface Raw {
        content?: string | null;
