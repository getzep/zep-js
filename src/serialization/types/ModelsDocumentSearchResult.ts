...
export const ModelsDocumentSearchResult: core.serialization.ObjectSchema<
    serializers.ModelsDocumentSearchResult.Raw,
    Zep.ModelsDocumentSearchResult
...
export declare namespace ModelsDocumentSearchResult {
    interface Raw {
        content?: string | null;
